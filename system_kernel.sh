...
write /proc/sys/kernel/sched_group_upmigrate 10
write /proc/sys/kernel/sched_group_downmigrate 10
write /proc/sys/kernel/sched_coloc_busy_hysteresis_enable_cpus 10
write /proc/sys/kernel/sched_asym_cap_sibling_freq_match_pct 10
write /proc/sys/kernel/sched_init_task_load 10
write /proc/sys/kernel/sched_spill_load 10
write /proc/sys/kernel/sched_min_task_util_for_colocation 10
write /proc/sys/kernel/sched_min_task_util_for_boost 10
