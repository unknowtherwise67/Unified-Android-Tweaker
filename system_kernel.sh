...
write /proc/sys/kernel/sched_rr_timeslice_us 10000000
write /proc/sys/kernel/sched_deadline_period_max_us 10000000
write /proc/sys/kernel/sched_deadline_period_min_us 10000000
write /proc/sys/kernel/sched_walt_cpu_high_irqload 10000000
write /proc/sys/kernel/sched_shares_window 10000000
write /proc/sys/kernel/sched_freq_aggregate_threshold 10000000
write /proc/sys/kernel/sched_freq_dec_notify 10000000
write /proc/sys/kernel/sched_freq_inc_notify 10000000
write /proc/sys/kernel/sched_pred_alert_freq 10000000
write /proc/sys/kernel/sched_rr_timeslice_ms 10000000
write /proc/sys/kernel/sched_time_avg_ms 10000000
write /proc/sys/kernel/sched_select_prev_cpu_us 10000000
write /proc/sys/kernel/sched_time_avg 10000000
write /proc/sys/kernel/sched_task_unfilter_period 10000000
write /proc/sys/kernel/sched_rt_period_us 10000000
write /proc/sys/kernel/sched_rt_runtime_us 10000000
write /proc/sys/kernel/sched_coloc_busy_hyst_max_ms 10000000
write /proc/sys/kernel/sched_freq_aggregate_threshold 10000000
write /proc/sys/kernel/sched_many_wakeup_threshold 10000000
...
write /proc/sys/kernel/sched_asym_cap_sibling_freq_match_pct 0
...
write /sys/kernel/debug/sched/sched_group_upmigrate 100
write /sys/kernel/debug/sched/sched_group_downmigrate 100
write /sys/kernel/debug/sched/sched_upmigrate 100
write /sys/kernel/debug/sched/sched_downmigrate 100
write /sys/kernel/debug/sched/sched_walt_init_task_load_pct 100
write /sys/kernel/debug/sched/sched_init_task_load 100
...
write /sys/kernel/debug/sched/sched_coloc_busy_hysteresis_enable_cpus 0
write /sys/kernel/debug/sched/sched_asym_cap_sibling_freq_match_pct 0
...
write /dev/stune/background/sched_cfs_boost 10
write /dev/stune/foreground/sched_cfs_boost 10
write /dev/stune/camera-daemon/sched_cfs_boost 10
write /dev/stune/system-background/sched_cfs_boost 10
...
write /dev/stune/h-background/sched_cfs_boost 10
write /dev/stune/l-background/sched_cfs_boost 10
...
write /dev/stune/background/schedtune.capacity_min 100
write /dev/stune/foreground/schedtune.capacity_min 100
write /dev/stune/camera-daemon/schedtune.capacity_min 100
write /dev/stune/system-background/schedtune.capacity_min 100
...
write /dev/stune/h-background/schedtune.capacity_min 100
write /dev/stune/l-background/schedtune.capacity_min 100
...
write /dev/stune/background/schedtune.cpucapacity_min 100
write /dev/stune/foreground/schedtune.cpucapacity_min 100
write /dev/stune/camera-daemon/schedtune.cpucapacity_min 100
write /dev/stune/system-background/schedtune.cpucapacity_min 100
...
write /dev/stune/h-background/schedtune.cpucapacity_min 100
write /dev/stune/l-background/schedtune.cpucapacity_min 100
...
write /dev/stune/background/schedtune.uclamp.100 100
write /dev/stune/foreground/schedtune.uclamp.100 100
write /dev/stune/camera-daemon/schedtune.uclamp.100 100
write /dev/stune/system-background/schedtune.uclamp.100 100
write /dev/stune/nnapi-hal/schedtune.uclamp.100 100
write /dev/stune/rt/schedtune.uclamp.100 100
write /dev/stune/application/schedtune.uclamp.100 100
write /dev/stune/kernel/schedtune.uclamp.100 100
write /dev/stune/restricted/schedtune.uclamp.100 100
write /dev/stune/top-app/schedtune.uclamp.100 100
write /dev/stune/audio-app/schedtune.uclamp.100 100
write /dev/stune/h-background/schedtune.uclamp.100 100
write /dev/stune/l-background/schedtune.uclamp.100 100
write /dev/stune/display/schedtune.uclamp.100 100
write /dev/stune/oiface_fg/schedtune.uclamp.100 100
write /dev/stune/sf/schedtune.uclamp.100 100
write /dev/stune/dex2oat/schedtune.uclamp.100 100
write /dev/stune/foreground_window/schedtune.uclamp.100 100
write /dev/stune/system/schedtune.uclamp.100 100

write /dev/stune/background/schedtune.uclamp.100.effective 100
write /dev/stune/foreground/schedtune.uclamp.100.effective 100
write /dev/stune/camera-daemon/schedtune.uclamp.100.effective 100
write /dev/stune/system-background/schedtune.uclamp.100.effective 100
write /dev/stune/nnapi-hal/schedtune.uclamp.100.effective 100
write /dev/stune/rt/schedtune.uclamp.100.effective 100
write /dev/stune/application/schedtune.uclamp.100.effective 100
write /dev/stune/kernel/schedtune.uclamp.100.effective 100
write /dev/stune/restricted/schedtune.uclamp.100.effective 100
write /dev/stune/top-app/schedtune.uclamp.100 100.effective 100
write /dev/stune/audio-app/schedtune.uclamp.100.effective 100
write /dev/stune/h-background/schedtune.uclamp.100.effective 100
write /dev/stune/l-background/schedtune.uclamp.100.effective 100
write /dev/stune/display/schedtune.uclamp.100.effective 100
write /dev/stune/oiface_fg/schedtune.uclamp.100.effective 100
write /dev/stune/sf/schedtune.uclamp.100.effective 100
write /dev/stune/dex2oat/schedtune.uclamp.100.effective 100
write /dev/stune/foreground_window/schedtune.uclamp.100.effective 100
write /dev/stune/system/schedtune.uclamp.100.effective 100

write /dev/stune/background/schedtune.uclamp.min 100
write /dev/stune/foreground/schedtune.uclamp.min 100
write /dev/stune/camera-daemon/schedtune.uclamp.min 100
write /dev/stune/system-background/schedtune.uclamp.min 100
...
write /dev/stune/h-background/schedtune.uclamp.min 100
write /dev/stune/l-background/schedtune.uclamp.min 100
...
write /dev/stune/background/schedtune.uclamp.min.effective 100
...
write /dev/stune/system-background/schedtune.uclamp.min.effective 100
...
write /dev/stune/h-background/schedtune.uclamp.min.effective 100
write /dev/stune/l-background/schedtune.uclamp.min.effective 100
...
write /dev/cpuctl/background/cpu.cpucapacity_min 100
write /dev/cpuctl/foreground/cpu.cpucapacity_min 100
write /dev/cpuctl/camera-daemon/cpu.cpucapacity_min 100
write /dev/cpuctl/system-background/cpu.cpucapacity_min 100
...
write /dev/cpuctl/h-background/cpu.cpucapacity_min 100
write /dev/cpuctl/l-background/cpu.cpucapacity_min 100
...
write /dev/cpuctl/background/cpu.uclamp.100 100
write /dev/cpuctl/foreground/cpu.uclamp.100 100
write /dev/cpuctl/camera-daemon/cpu.uclamp.100 100
write /dev/cpuctl/system-background/cpu.uclamp.100 100
write /dev/cpuctl/nnapi-hal/cpu.uclamp.100 100
write /dev/cpuctl/rt/cpu.uclamp.100 100
write /dev/cpuctl/application/cpu.uclamp.100 100
write /dev/cpuctl/kernel/cpu.uclamp.100 100
write /dev/cpuctl/restricted/cpu.uclamp.100 100
write /dev/cpuctl/top-app/cpu.uclamp.100 100
write /dev/cpuctl/audio-app/cpu.uclamp.100 100
write /dev/cpuctl/h-background/cpu.uclamp.100 100
write /dev/cpuctl/l-background/cpu.uclamp.100 100
write /dev/cpuctl/display/cpu.uclamp.100 100
write /dev/cpuctl/oiface_fg/cpu.uclamp.100 100
write /dev/cpuctl/sf/cpu.uclamp.100 100
write /dev/cpuctl/dex2oat/cpu.uclamp.100 100
write /dev/cpuctl/foreground_window/cpu.uclamp.100 100
write /dev/cpuctl/system/cpu.uclamp.100 100

write /dev/cpuctl/background/cpu.uclamp.100.effective 100
write /dev/cpuctl/foreground/cpu.uclamp.100.effective 100
write /dev/cpuctl/camera-daemon/cpu.uclamp.100.effective 100
write /dev/cpuctl/system-background/cpu.uclamp.100.effective 100
write /dev/cpuctl/nnapi-hal/cpu.uclamp.100.effective 100
write /dev/cpuctl/rt/cpu.uclamp.100.effective 100
write /dev/cpuctl/application/cpu.uclamp.100.effective 100
write /dev/cpuctl/kernel/cpu.uclamp.100.effective 100
write /dev/cpuctl/restricted/cpu.uclamp.100.effective 100
write /dev/cpuctl/top-app/cpu.uclamp.100 100.effective 100
write /dev/cpuctl/audio-app/cpu.uclamp.100.effective 100
write /dev/cpuctl/h-background/cpu.uclamp.100.effective 100
write /dev/cpuctl/l-background/cpu.uclamp.100.effective 100
write /dev/cpuctl/display/cpu.uclamp.100.effective 100
write /dev/cpuctl/oiface_fg/cpu.uclamp.100.effective 100
write /dev/cpuctl/sf/cpu.uclamp.100.effective 100
write /dev/cpuctl/dex2oat/cpu.uclamp.100.effective 100
write /dev/cpuctl/foreground_window/cpu.uclamp.100.effective 100
write /dev/cpuctl/system/cpu.uclamp.100.effective 100
...
write /dev/cpuctl/h-background/cpu.uclamp.min 100
write /dev/cpuctl/l-background/cpu.uclamp.min 100
...
write /dev/cpuctl/background/cpu.uclamp.min.effective 100
write /dev/cpuctl/foreground/cpu.uclamp.min.effective 100
write /dev/cpuctl/camera-daemon/cpu.uclamp.min.effective 100
write /dev/cpuctl/system-background/cpu.uclamp.min.effective 100
...
write /dev/cpuctl/h-background/cpu.uclamp.min.effective 100
write /dev/cpuctl/l-background/cpu.uclamp.min.effective 100
